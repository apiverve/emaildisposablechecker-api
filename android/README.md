# Disposable Email Checker Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:emaildisposablechecker-api:1.1.14'
}
```
...
```java
import com.apiverve.emaildisposablechecker.DisposableEmailCheckerAPIClient;
import com.apiverve.emaildisposablechecker.APIResponse;
import com.apiverve.emaildisposablechecker.APIException;

// Initialize the client
DisposableEmailCheckerAPIClient client = new DisposableEmailCheckerAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/emaildisposablechecker](https://docs.apiverve.com/ref/emaildisposablechecker)
...
- **Documentation:** [https://docs.apiverve.com/ref/emaildisposablechecker](https://docs.apiverve.com/ref/emaildisposablechecker)
- **Issues:** [GitHub Issues](https://github.com/apiverve/emaildisposablechecker-api/issues)
