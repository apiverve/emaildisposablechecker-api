...
namespace APIVerve\Emaildisposablechecker;
...
/**
 * Client for the Disposable Email Checker API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://emaildisposablechecker.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/emaildisposablechecker';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\EmaildisposablecheckerClient] {$message}\n";
        }
    }
}
